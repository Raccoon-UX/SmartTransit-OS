...
export function LoginPage({
  ...
  return (
    <div className="relative min-h-screen w-full text-slate-900 flex flex-col justify-center py-6 sm:py-10 px-4 sm:px-6 lg:px-8 text-left overflow-x-hidden bg-slate-950 font-sans select-none">
      ...
      {/* Foreground Content Container (90-92vw, max-w 1400-1500px) */}
      <div className="relative z-10 max-w-[1440px] mx-auto w-full space-y-3.5">
        {/* Top Slim Security & Navigation Bar */}
        <div className="w-full flex items-center justify-between bg-slate-900/85 backdrop-blur-md px-4 sm:px-6 py-2.5 rounded-xl border border-slate-700/60 text-white shadow-lg">
          <button
            type="button"
        ...
        <div className="bg-white rounded-2xl border border-slate-200/90 shadow-2xl shadow-slate-950/50 overflow-hidden">
          ...
          <div className="p-5 sm:p-6 bg-slate-50/90 border-b border-slate-200 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <div className="flex items-center space-x-4 shrink-0">
              ...
              />
              <div className="border-l border-slate-300 pl-4 sm:pl-5 shrink-0">
                <h1 className="text-lg sm:text-xl md:text-2xl font-extrabold text-slate-900 font-sans tracking-tight leading-tight">
          ...
          <div className="px-5 sm:px-6 py-3 bg-amber-500/10 border-b border-amber-500/20 text-xs font-mono text-amber-900 flex items-center space-x-2.5">
          ...
          <div className="p-6 sm:p-8 xl:p-10 grid grid-cols-1 lg:grid-cols-2 gap-8 xl:gap-10 items-start">
            
            {/* ============================================================ */}
            {/* LEFT COLUMN (~50%): OFFICIAL SIGN-IN CARD                    */}
            {/* ============================================================ */}
            <div className="space-y-5">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1.5 text-left">
                  ...
                  <div className="relative flex items-center">
                    ...
                    <input
                      ...
                      className={cn(
                        'w-full h-[52px] sm:h-[56px] text-sm sm:text-base rounded-xl pl-11 pr-4 transition-all duration-150',
                ...
                <div className="space-y-1.5 text-left">
                  ...
                  <div className="relative flex items-center">
                    ...
                    <input
                      ...
                      className={cn(
                        'w-full h-[52px] sm:h-[56px] text-sm sm:text-base rounded-xl pl-11 pr-11 transition-all duration-150',
                        'bg-white border border-slate-300 text-slate-900 placeholder:text-slate-400',
                        'focus:outline-none focus:ring-2 focus:ring-[#0B3D91] focus:border-[#0B3D91] shadow-2xs'
                      )}
                      required
                ...
                <div className="flex items-center justify-between text-xs sm:text-sm font-sans pt-0.5">
                  ...
                  {onNavigateForgotPassword && (
                    <button
                      ...
                      className="text-[#0B3D91] hover:text-[#082e6d] font-semibold hover:underline cursor-pointer"
                    >
                ...
                <button
                  ...
                  disabled={isLoading}
                  className={cn(
                    'w-full h-[52px] sm:h-[56px] flex items-center justify-center space-x-2 px-5 rounded-xl font-sans font-bold text-sm sm:text-base text-white transition-all duration-200 cursor-pointer shadow-md',
                ...
                {onNavigateRegister && (
                  <div className="text-center text-xs sm:text-sm text-slate-600 pt-2 border-t border-slate-100">
                    ...
                    <button
                      ...
                      className="text-[#0B3D91] font-bold hover:underline cursor-pointer ml-1 inline-flex items-center space-x-1"
                    >
            ...
            {/* ============================================================ */}
            {/* RIGHT COLUMN (~50%): STRUCTURED SANDBOX ROLE PROFILES CARD   */}
            {/* ============================================================ */}
            <div className="bg-slate-50/70 p-5 sm:p-6 rounded-2xl border border-slate-200/90 space-y-4">
              <div className="flex items-center justify-between border-b border-slate-200 pb-3">
                ...
                <span className="text-[10px] font-mono px-2.5 py-0.5 rounded bg-emerald-500/10 text-emerald-700 border border-emerald-500/20 font-bold uppercase">
                  ACTIVE
                </span>
              </div>
