  ...
  return (
    <aside
      className={cn(
        ...
        'bg-[#F7F5F0] dark:bg-slate-900 border-[#E5E0D8] dark:border-slate-800',
        collapsed ? 'w-16' : 'w-64',
        className
      )}
    >
      ...
      <div className="p-3 border-b border-[#E5E0D8] dark:border-slate-800">
        {!collapsed ? (
          <div className="px-3 py-2 rounded-lg bg-white dark:bg-slate-800 border border-[#E5E0D8] dark:border-slate-700 flex items-center justify-between shadow-subtle">
          ...
          <div className="flex justify-center">
            <div className="w-7 h-7 rounded bg-[#1769D1]/10 dark:bg-sky-400/10 text-[#1769D1] dark:text-sky-400 border border-[#1769D1]/30 dark:border-sky-400/30 flex items-center justify-center font-mono font-bold text-xs">
      ...
      <div className="flex-1 overflow-y-auto p-2 space-y-4">
        {roleConfig.sections.map((section, sIdx) => (
          <div key={sIdx} className="space-y-0.5">
            {!collapsed && (
              <div className="px-3 py-1.5 text-[10px] font-mono uppercase font-bold tracking-wider text-[#596273] dark:text-slate-400">
            ...
            {section.items.map((item) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    'w-full flex items-center px-3 py-2 text-xs font-medium transition-all relative border-l-2 cursor-pointer',
                    isActive
                      ? 'bg-white dark:bg-slate-800 text-[#1769D1] dark:text-sky-400 border-[#1769D1] dark:border-sky-400 font-bold shadow-subtle rounded-r-lg'
                      : 'text-[#596273] dark:text-slate-300 hover:bg-white/60 dark:hover:bg-slate-800/80 hover:text-[#172033] dark:hover:text-white border-transparent'
                  )}
                >
                  ...
                  {!collapsed && item.badge && (
                    <span
                      className={cn(
                        'text-[10px] font-mono font-bold px-1.5 py-0.2 rounded text-[#596273] dark:text-slate-300 bg-[#ECE8DF] dark:bg-slate-800 border border-transparent dark:border-slate-700'
                      )}
                    >
                      {item.badge}
                    </span>
